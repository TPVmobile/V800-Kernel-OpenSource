...
#define GPIO_VOICE_CHANNEL_PIN (GPIO19|0x80000000)
static void enable_voice_channel(void){
    ACCDET_DEBUG("[Accdet]enable_voice_channel");
    mt_set_gpio_mode(GPIO_VOICE_CHANNEL_PIN, GPIO_MODE_GPIO);
    mt_set_gpio_dir(GPIO_VOICE_CHANNEL_PIN, GPIO_DIR_OUT);
    mt_set_gpio_pull_enable(GPIO_VOICE_CHANNEL_PIN, GPIO_PULL_DISABLE);
    mt_set_gpio_out(GPIO_VOICE_CHANNEL_PIN, GPIO_OUT_ONE); 
}

static void disable_voice_channel(void){
    ACCDET_DEBUG("[Accdet]disable_voice_channel");
    mt_set_gpio_mode(GPIO_VOICE_CHANNEL_PIN, GPIO_MODE_GPIO);
    mt_set_gpio_dir(GPIO_VOICE_CHANNEL_PIN, GPIO_DIR_OUT);
    mt_set_gpio_pull_enable(GPIO_VOICE_CHANNEL_PIN, GPIO_PULL_DISABLE);
    mt_set_gpio_out(GPIO_VOICE_CHANNEL_PIN, GPIO_OUT_ZERO); 
}
