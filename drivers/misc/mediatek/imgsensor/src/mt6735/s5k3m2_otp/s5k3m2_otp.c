...
#if 1 //liuying@wind-mobi.com 20150311 begin
...
int  read_3m2_eeprom_for_mtk_new(void ){
	...
	u8 s5k3m2_eeprom_data[2] = {0, 0}; // add lanhai read 0x0782、0x0783，检验eeprom data
	...
	s5k3m2_eeprom_data[0] = read_cmos_sensor_8(0x0782);
	s5k3m2_eeprom_data[1] = read_cmos_sensor_8(0x0783);
	printk("====lanhai 0x0782 = %x  0x0783 = %x----\n", s5k3m2_eeprom_data[0], s5k3m2_eeprom_data[1]);
      #endif
	   
    return 0;
}
#endif 
//liuying@wind-mobi.com 20150311 end
