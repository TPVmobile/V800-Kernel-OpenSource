...
/* sanford.lin add on 20151028 for get driver information */
#if 1//def AEON_DEVICE_PROC_MANAGER
...
/* sanford.lin add on 20151028 for get driver information */
#if 1//def AEON_DEVICE_PROC_MANAGER
static int main_cam_proc_oem_read(struct file *file, char *buffer, size_t count, loff_t *ppos)
{
	char *page = NULL;
    char *ptr = NULL;
	int len, err = -1;
...
static int sub_cam_proc_oem_read(struct file *file, char *buffer, size_t count, loff_t *ppos)
{
	char *page = NULL;
    char *ptr = NULL;
	int len, err = -1;
