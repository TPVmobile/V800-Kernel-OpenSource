...
#define CUST_EINT_ALS_TYPE			8//CUST_EINTF_TRIGGER_LOW
#define CUST_EINT_ALS_DEBOUNCE_EN      0//CUST_EINT_DEBOUNCE_DISABLE
...
/*----------------------------------------------------------------------------*/
	...
	#define STK_LT_N_CT	(40)//30
	#define STK_HT_N_CT	 (60)//50
