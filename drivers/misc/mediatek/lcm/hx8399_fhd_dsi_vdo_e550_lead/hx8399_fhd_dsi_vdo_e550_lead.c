...
data_array[1]=0x2EF400B1;
data_array[2]=0x2209112E;
...
dsi_set_cmdq(data_array, 10, 1);
	...
	data_array[1]=0x070600E0;
	data_array[2]=0x213E2F2A;
	data_array[3]=0x0D110F38;
	data_array[4]=0x0E0C0F0E;
	data_array[5]=0x1A0F1410;
	data_array[6]=0x06001206;
	data_array[7]=0x3E2F2A07;	
	data_array[8]=0x110F3821;
	data_array[9]=0x0C0F0E0D;
	data_array[10]=0x0F14100E;
	data_array[11]=0x0012061A;
	dsi_set_cmdq(data_array, 12, 1);

	
data_array[0]=0x00033902;
data_array[1]=0x002A34b6;
dsi_set_cmdq(data_array, 2, 1);
...
LCM_DRIVER hx8399_fhd_dsi_vdo_e550_lead_lcm_drv = 
{
    .name			= "hx8399_fhd_dsi_vdo_e550_lead",
