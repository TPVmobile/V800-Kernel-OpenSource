...
#define LCD_LDO_EN_GPIO_PIN          							(GPIO2)
...
static struct LCM_setting_table lcm_initialization_setting[] = {
	...
	{0xC7,30,{0x01,0x0A,0x13,0x1A,0x2B,0x39,0x43,0x54,0x38,0x41,0x51,0x61,0x6B,0x72,0x7C,0x01,0x0A,0x13,0x1A,0x2B,0x39,0x43,0x54,0x38,0x41,0x51,0x61,0x6B,0x72,0x7C}},
	...
	{0xD3,25,{0x1B,0x33,0xBB,0xBB,0xB3,0x33,0x33,0x33,0x01,0x01,0x00,0xA0,0xD8,0xA0,0x0d,0x4A,0x4A,0x44,0x3B,0x37,0x72,0x07,0x3D,0xBF,0x33}},
	{0xD5,7,{0x06,0x00,0x00,0x01,0x3A,0x01,0x3A}},
	{0xD5,7,{0x06,0x00,0x00,0x01,0x3A,0x01,0x3A}},
	{0xCC,1,{0x0B}},
	{0xD6,1,{0x01}},
...
static void lcm_init(void)
{
    ...
    printf("%s, %d,r63315 id = 0x%x\n",__FUNCTION__,__LINE__,lcd_id);
    	...
    	lcm_util.set_gpio_mode(LCD_LDO_EN_GPIO_PIN, GPIO_MODE_00);
	lcm_util.set_gpio_dir(LCD_LDO_EN_GPIO_PIN, GPIO_DIR_OUT); 
	lcm_util.set_gpio_out(LCD_LDO_EN_GPIO_PIN , 0); //for GPIO reset type  reset low 
	MDELAY(10);

	lcm_util.set_gpio_out(LCD_LDO_EN_GPIO_PIN, 1);	//for LCD idle current= 3.8mA
...
static void lcm_suspend(void)
{
    ...
    lcm_util.set_gpio_out(LCD_LDO_EN_GPIO_PIN , 0);
...
static unsigned int lcm_compare_id(void)
{
	...
	SET_GPIO_OUT(LCD_LDO_EN_GPIO_PIN , 1);//power on +5
