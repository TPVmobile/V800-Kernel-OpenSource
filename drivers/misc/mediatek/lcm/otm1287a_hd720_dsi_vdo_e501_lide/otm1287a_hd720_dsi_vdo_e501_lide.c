...
//-------------------- panel timing setting --------------------//
	...
	{0xcf,11,{0x01,0x01,0x20,0x20,0x00,0x00,0x01,0x81,0x10,0x00,0x00}}, //gate pre. ena.

	{0x00,1,{0xb5}},             //TCON_GOA_OUT Setting
	{0xc5,6,{0x00,0x6f,0xfF,0x00,0x6f,0xfF}},

	{0x00,1,{0x00}},                                                                                 ///////////////////////
	{0xE1,20,{0x03,0x0C,0x15,0x1D,0x2B,0x36,0x37,0x61,0x53,0x6E,0x93,0x79,0x87,0x59,0x52,0x41,0x2E,0x1D,0x15,0x10}},

	{0x00,1,{0x00}},
	{0xE2,20,{0x03,0x0C,0x15,0x1E,0x2B,0x36,0x37,0x61,0x53,0x6E,0x93,0x79,0x87,0x59,0x52,0x41,0x2E,0x1D,0x15,0x10}},
...
//#else
	params->dsi.PLL_CLOCK = 206; //this value must be in MTK suggested table
//#endif
//#else
...
#ifdef BUILD_LK
	printf("LK lcm_compare_id otm1287a buffer[0] = 0x%x,buffer[1] = 0x%x,buffer[2] = 0x%x\n",buffer[0],buffer[1],buffer[2]);
#else
	printk("Kernel lcm_compare_id otm1287a buffer[0] = 0x%x,buffer[1] = 0x%x,buffer[2] = 0x%x\n",buffer[0],buffer[1],buffer[2]);
...
LCM_DRIVER otm1287a_hd720_dsi_vdo_e501_lide_lcm_drv = 
{
    .name			= "otm1287a_hd720_dsi_vdo_e501_lide",
