...
int kdCISModulePowerOn_S5K3L2_On(u32 pinSetIdx, char* mode_name){
	//in case
...
int kdCISModulePowerOn_S5K3L2_Off(u32 pinSetIdx, char* mode_name)
{
	if(pinSetIdx != 0) return 0;
...
static int kdCISModulePowerOn_S5K3L2XX_On(int pinSetIdx, char* mode_name)
{
	if(pinSetIdx != 0) return 0;
				//power ON
			ISP_MCLK1_EN(1);
...
static int kdCISModulePowerOn_S5K3L2XX_Off(int pinSetIdx, char* mode_name)
{
	if(pinSetIdx != 0) return 0;
				//power ON
			ISP_MCLK1_EN(0);
...
int kdCISModulePowerOn_S5K3M2_On(u32 pinSetIdx, char* mode_name){
	//in case
		    if(pinSetIdx != 0) return 0;
...
int kdCISModulePowerOn_S5K3M2_Off(u32 pinSetIdx, char* mode_name)
{
	if(pinSetIdx != 0) return 0;
...
{
printk("lanhai %s SensorIdx = %d, currSensorName = %s On = %d\n", __func__, SensorIdx, currSensorName, On);
