...
static DEVICE_ATTR(Flashlight_Ctl, 0777, show_Flashlight_Ctl, store_Flashlight_Ctl);

/************************************end****************************************************/
/************************aeon add for factory mode flashlight test*********************/
static ssize_t show_Flashlight_Ctl0(struct device *dev,struct device_attribute *attr, char *buf)
{
	return sprintf(buf, "%d\n", Flashlight_Switch);
}
static ssize_t store_Flashlight_Ctl0(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
	if(buf != NULL && size != 0)
			{
					if(buf[0]== '0')
...
static DEVICE_ATTR(Flashlight_Ctl0, 0664, show_Flashlight_Ctl0, store_Flashlight_Ctl0);
...
static int flashlight_probe(struct platform_device *dev)
{
	...
	int ret_device_file0 = 0;//aeon add for factory mode
	...
	ret_device_file0 = device_create_file(&(dev->dev), &dev_attr_Flashlight_Ctl0); //aeon add for factory mode
    //initialize members
