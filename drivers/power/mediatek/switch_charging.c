...
static kal_uint32 charging_full_check(void)
{
	...
	printk(KERN_ERR"jacob test g_full_check_count=%d,status= %d,BMT_status.bat_vol=%d\n",
...
PMU_STATUS BAT_BatteryFullAction(void)
{
	...
	if (BMT_status.bat_vol < RECHARGING_VOLTAGE) {   //if (charging_full_check() == KAL_FALSE) {  //sanford.lin 20151116 for recharging bug
