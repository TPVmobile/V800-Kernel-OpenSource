...
#define LCM_X_MAX	 720//576  
#define LCM_Y_MAX	 1280 //1792//960 

/****************************elan data info****************************/
//i2c info
#define ELAN_TS_NAME "mtk-tpd-elan"

#define ELAN_7BITS_ADDR 0x10
#define ELAN_7BITS_ADDR_B      0x15
...
#define TPD_BUTTON_MAX		(LCM_Y_MAX+TPD_BUTTON_HEIGH)
#define TPD_KEY_COUNT		3
#define TPD_KEYS				{ BTN_LEFT, BTN_MIDDLE, BTN_RIGHT}
#define TPD_KEYS_DIM		{\	
                                {30,TPD_BUTTON_MAX,120,TPD_BUTTON_HEIGH},\
								{360,TPD_BUTTON_MAX,120,TPD_BUTTON_HEIGH},\
								{690,TPD_BUTTON_MAX,120,TPD_BUTTON_HEIGH}\
							}
/*{x,y,x_range,y_range},button x = (x-x_range, x+x_range), button y = (y-x_range, y+x_range)*/
...
//#define IAP_PORTION
	...
	static uint8_t file_fw_data[] = {
                  //#include "FW_Inside_5515_151218.i"
                 // #include "FW_Inside_5518_160104.i"
	};

	static uint8_t file_fw_data_b[] = {
                  //#include "FW_Outside_5516_151218.i"
                 // #include "FW_Outside_5519_160104.i"
	};
